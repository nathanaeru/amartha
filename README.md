...
- A beautiful app dock with minimal icons from [Phosphor Icons](https://phosphoricons.com/). By default they opens Brave, File Explorer, Windows Terminal, VS Code, and Recycle Bin respectively. Can be edited by modifying `Dock.ini`.
...
- Copy the [`@Resources`](./@Resources/), [`Clock`](./Clock/), [`Dock`](./Dock/), and [`Fastfetch`](./Fastfetch/) folders to your Rainmeter skins folder.
